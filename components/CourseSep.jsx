  ...
  const data = [
    {
      ...
      cname: 'HTML & CSS',
      cdesc:
        'Are you ready to embark on a creative journey into the world of web design? Welcome to "Web Design Fundamentals: HTML & CSS Mastery," a comprehensive course designed to equip you with the essential skills and knowledge needed to create stunning and functional websites from scratch.',
      crank: 4,
      clang: 'English',
      cobj: [
    ...
    <div className="pb-24">
      <div className="grid md:grid-cols-3">
        {data.map((values, index) => (
          <>
            <div key={index} className="col-span-2 mx-8 px-4">
              <h1 className="my-5 mb-2 text-3xl font-bold dark:text-gray-400">
                {values.cname}
              </h1>
            ...
            <div>
              <img className="my-3 mr-3 h-[75%]" src={values.cimg} />
              <Link
                href="/courses/htmlCss"
                className=" my-2 flex w-[30%] items-center rounded-lg bg-blue-700 px-3 py-2 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
                View Course
